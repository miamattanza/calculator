...
const DICT = {
  ...
  id: {
    ...
    upload_icon: 'Unggah ikon sendiri', icon_rules: 'PNG, JPG atau WEBP, maks 3 MB', keep_categories: 'Simpan kategori', delete_data_q: 'Hapus apa?', background: 'Latar', bg_none: 'Tanpa latar', bg_custom: 'Gambar sendiri', theme_manual: 'Manual', theme_color: 'Warna latar', brightness: 'Kecerahan', tab_planning: 'Perencanaan', goal_name: 'Ingin beli apa', goal_amount: 'Jumlah', calc: 'Hitung', goal_eta: 'Akan terkumpul sekitar', goal_unreachable: 'Dengan tren saat ini tidak bisa menabung: pengeluaran ≥ pemasukan', not_enough_data: 'Data terlalu sedikit untuk perkiraan akurat. Makin sering pakai aplikasi, makin akurat.', monthly_rate: 'Rata-rata per bulan', loan_info: 'Jika ambil pinjaman — dengan laju ini kira-kira dilunasi dalam waktu yang sama', no_goals: 'Belum ada tujuan', budget_total: 'Total batas bulanan', budget_detail: 'Rincikan per kategori', budget_over: 'Batas terlampaui', set_limit: 'Atur batas', months_short: 'bln', days_short: 'h',
  },
  ...
  es: {
    ...
    upload_icon: 'Sube tu icono', icon_rules: 'PNG, JPG o WEBP, hasta 3 MB', keep_categories: 'Mantener categorías', delete_data_q: '¿Qué eliminar?', background: 'Fondo', bg_none: 'Sin fondo', bg_custom: 'Imagen propia', theme_manual: 'Manual', theme_color: 'Color de fondo', brightness: 'Brillo', tab_planning: 'Planificación', goal_name: 'Qué comprar', goal_amount: 'Importe', calc: 'Calcular', goal_eta: 'Ahorrarás alrededor de', goal_unreachable: 'Con la tendencia actual no podrás ahorrar: gastos ≥ ingresos', not_enough_data: 'Muy pocos datos para una previsión precisa. Cuanto más uses la app, más precisa será.', monthly_rate: 'Media al mes', loan_info: 'Si pides un préstamo — al ritmo actual lo devolverías en aproximadamente el mismo tiempo', no_goals: 'Aún no hay objetivos', budget_total: 'Límite mensual total', budget_detail: 'Detallar por categoría', budget_over: 'Límite superado', set_limit: 'Definir límite', months_short: 'mes', days_short: 'd',
  },
